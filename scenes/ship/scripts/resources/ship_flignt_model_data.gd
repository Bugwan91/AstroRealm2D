...
@export_range(0.1, 1000.0) var mass: float = 1.0: set = _set_mass
@export_range(1.0, 10000.0) var speed: float = 2000.0: set = _set_speed
@export_range(0.0, 1000.0) var boost_base: float = 200.0: set = _update_boost
@export_range(0.0, 1000.0) var strafe_base: float = 100.0: set = _update_strafe
