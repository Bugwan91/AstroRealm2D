...
func _process(_delta):
	...
	#TODO: particle effects like this should be global positioned instead of current configuration
	# as there is no more floating origin that brakes global velocities
